                ...
                <div className='mt-2'>
                    ...
                    <div className='mt-2 flex flex-col md:flex-row justify-between items-center'>
                        <div className='w-full md:w-1/2 mx-6'>
                            <p className=' mb-4 lg:mb-8 text-sm'>Get expert advice on your ERP strategy to optimize processes and overcome challenges. Our seasoned consultants bring years of experience in implementing and customizing ERP solutions tailored to your business needs. We analyze your current workflows, identify bottlenecks, and recommend best practices that enhance efficiency and productivity.</p>
            ...
            <section className='p-12 shadow-inner' data-aos="zoom-in">
                <div className='flex flex-col md:flex-row justify-between gap-5'>
                    ...
                    <div className='w-full md:w-1/2'>
                        <p className='text-gray-950  text-3xl lg:text-4xl font-bold mb-6' style={{ color: '#0056b3' }}>Odoo Functional Consultant</p>
                        <p className='text-gray-950 text-sm'>At Wrocus Technology, we bring over 5 years of expertise in Odoo consulting services to enhance our clients' businesses. Our skilled team is dedicated to optimizing the platform, ensuring it is user-friendly and tailored to meet specific needs. With extensive experience across various industries.</p>
                        <p className='mt-6 hidden sm:block '>We possess a deep understanding of operational workflows. This knowledge enables us to provide innovative solutions that address challenges and facilitate seamless integration, empowering your organization to thrive.</p>
                    </div>
                </div>

                <div className='flex flex-col md:flex-row justify-between mt-6 py-6 gap-5 shadow-inner' data-aos="zoom-in">
                    <div className='w-full md:w-1/2'>
