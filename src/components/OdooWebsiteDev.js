        ...
        <>
            <section className='bg-gray-100'>
                ...
                <p className='text-center text-3xl p-4 font-bold ' style={{ color: '#0056b3' }}>Odoo Website Development</p>
                    ...
                    <div className='rounded-lg  p-8  mt-0'>
                        {/* <h2 className='text-2xl font-semibold mb-12 text-center' style={{ color: '#0056b3' }}>Our Services</h2> */}
                        <div className='flex justify-between'>
                            <div className='w-1/2  lg:ml-12'>
                                <img src='https://media.licdn.com/dms/image/C5612AQGpwJPnvMx8NA/article-cover_image-shrink_720_1280/0/1616578587955?e=2147483647&v=beta&t=5gMCCd926R9tMkqcswVIswqCBsljR8tZmAqs5iguq_A'
                                    style={{ height: '300px' }}
                                />

                            </div>
                            <div className='w-1/2 mt-6'>
                                <ul className='list-disc list-inside font-semibold text-gray-950'>
                    ...
                    <div className='flex mt-6 bg-white py-12'>
                        <div className='bg-white rounded-lg  p-6 w-1/2 flex justify-center flex-col'>
